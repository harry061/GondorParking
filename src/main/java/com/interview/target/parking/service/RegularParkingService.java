...
@Component
public class RegularParkingService extends BaseParkingService implements PrivilegedParkingService {

    @Override
    public ParkingToken reserveSlot(ParkingRequest parkingRequest) throws Exception {
        return this.confirmSlot(parkingRequest, slotNearExitPredicate);
    }
    ...
    public boolean fit(ParkingType parkingType) {
        return parkingType.toString().equals("O");
    }
}
